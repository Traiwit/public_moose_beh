"""Description for the odb_04.OdbReader_ext extension module
...
ext_modules.append(
    Extension(
        name = "bae.odb_04.odbReader_ext",
        sources = [
            'bae/odb_04/fieldValueMap.cc',
            'bae/odb_04/interpolation.cc',
            'bae/odb_04/odbReader_ext.cc',],
    )
)
...
def _build_odbAccessServer(install_dir):
    ...
    if versions:
        print("Preparing odb_04 extension module for: %s" % ", ".join(
