...
# _registeredEntities. These field values have to come as numpy-convertible
...
#   * _checkConsistency fuction - to check the 'length' of _registeredEntities
...
class UnstructuredMesh(StaticEntities):
