...
#include "PorousFlowDarcyVelocityComponentYearToSec.h"

registerMooseObject("PorousFlowApp", PorousFlowDarcyVelocityComponentYearToSec);

InputParameters
PorousFlowDarcyVelocityComponentYearToSec::validParams()
{
...
PorousFlowDarcyVelocityComponentYearToSec::PorousFlowDarcyVelocityComponentYearToSec(
...
Real
PorousFlowDarcyVelocityComponentYearToSec::computeValue()
{
  return -3.17098e-8*(_permeability[_qp] * (_grad_p[_qp][_ph] - _fluid_density_qp[_qp][_ph] * _gravity) *
